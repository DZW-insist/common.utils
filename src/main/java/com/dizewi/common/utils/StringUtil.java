...
public class StringUtil {
	...
	* @throws
	...
	public static String randomChineseName() {
		...
		// 随机获取姓氏
		String name1 = surname[RandomUtil.randomNumber(0, surname.length - 1)];
		// 随机获取1-2个中文
		String name2 = randomChineseString(RandomUtil.randomNumber(1, 2));
		return name1 + name2;
	}
	/**
	...
	* @throws
	...
	public static String randomSex() {
		String[] sexs = { "男", "女" };
		// 随机获取性别
		String sex = sexs[RandomUtil.randomNumber(0, 1)];
		return sex ;
	}
